...
import vn.edu.poly.myapplication.dao.TheLoaiDAO;
import vn.edu.poly.myapplication.model.TheLoai;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
    ...
    public void addTheloai() {
        ...
        TheLoai theloai = new TheLoai(edtMaTheLoai.getText().toString(), edttentheloai.getText().toString(), edtmota.getText().toString(), edtvitri.getText().toString());
        try {
            if (validateForm()>0){
    ...
    public void Show(View view) {
        Intent intent=new Intent(ThemTheLoai.this,ListNguoiDungActivity.class);
        startActivity(intent);
    }
}